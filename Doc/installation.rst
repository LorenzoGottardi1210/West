...
In order to install WEST you need to download `Quantum ESPRESSO 7.6 <https://gitlab.com/QEF/q-e/-/tags>`_.
...
.. code-block:: bash
   ...
   $ git clone -b 'qe-7.6' --single-branch --depth 1 https://gitlab.com/QEF/q-e.git QEdir
   $ cd QEdir
   $ git clone -b 'v6.4.0' --single-branch --depth 1 https://github.com/west-code-development/West.git West
   $ ./configure
